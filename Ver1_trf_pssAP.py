...
def Func_Initial_PSSAP():
    ...
    lb=np.array([0.0199,0.0199,4,4,4,2,0.999,5,0.1,0.01,0.01])
    ub=np.array([0.0201,0.0201,6,6,6,7,1.001,7,0.9,0.9 ,2   ])
    bounds=(lb, ub)
    
#    Phase_AVR=np.array([-8,-15,-22,-32,-41,-48,-52,-57,-62,-66,\
#
...
def Func_Parameter_Calculate(x0,w,Phase_AVR,bounds):
    ...
    T1,T2,T3,T4,T5,T6,K,K1,K2,a,p=x0
    x=x0
    lb, ub=bounds
    counter=0
...
PhaseSUM,n=Func_Plot_PSSAP(x0,w0,Phase_AVR);
